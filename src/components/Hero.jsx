    ...
    <section className='max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row'>
      <div className='hero-map'/>
        ...
        <div className='relative z-20 flex flex-1 flex-col xl:w-1/2'>
            <img src={Camp} alt="Camp" width={50} height={50} className=' left-[-5px] top-[-30px] w-10 lg:w-[50px]'/>
        ...
        <div className='my-11 flex flex-wrap gap-2'>
            ...
            <img src={Star} key={index} width={24} height={24}/>
            ))
        }
        ...
        <div className='flex flex-col w-full gap-3 sm:flex-row'>
            <Button type='button' name='Download App' variant='btn_green' icon={Download}/>
            <Button type='button' name='How We Work' variant='btn_white_text' icon={Play}/>
        </div>
        </div>
            ...
            <div className='relative z-20 flex w-[268px] flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8'>
              ...
              <div className='flex flex-col'>
                ...
                <div className=' flex flex-col'>
                  ...
                  <p className='bold-20 text-white'>172.68 mi</p>
                </div>
                <div className=' flex flex-col'>
